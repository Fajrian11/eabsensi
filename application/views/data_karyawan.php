...
<head>
  ...
  <title>E-ABSENSI | Data Karyawan</title>
                ...
                <table id="tbl_karyawan" class="table table-bordered table-hover">
                  ...
                  <?php 
                      ...
                      while($row = mysqli_fetch_array($q)){
                        echo "<tr>";
                        echo     "<td>".$no++."</td>";
                        echo     "<td>".$row['kd_karyawan']."</td>";
                        echo     "<td>".$row['nama_karyawan']."</td>";
                        echo     "<td>".$row['jabatan']."</td>";
                        echo     "<td>".$row['id_shift']."</td>";
                        echo     "<td>".$row['id_gedung']."</td>";
                        // echo     "<td><a href='edit.php?id=$row[id]'>Edit</a>|<a href='delete.php?id=$row[id]'>Delete</a></td>";
                        echo     "<td><a href='../backend/master/karyawan/edit.php?id=$row[id]' type='button' class='btn btn-block btn-primary'>Edit</a></td>";
                        echo     "<td><a href='../backend/master/karyawan/delete.php?id=$row[id]' type='button' class='btn btn-block btn-danger'>Hapus</a></td>";
      ...
      <form action="" method="post" enctype="multipart/form-data">
        <div class="modal-body">
          <div class="form-group">
            <label class="control-label" for="kd_karyawan">Kode</label>
            <input type="text" name="kd_karyawan" class="form-control" id="kd_karyawan" required>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label class="control-label" for="id_shift">Shift</label>
            <input type="text" name="id_shift" class="form-control" id="id_shift" required>
          </div>
          <div class="form-group">
            <label class="control-label" for="id_gedung">Gedung</label>
            <input type="text" name="id_gedung" class="form-control" id="id_gedung" required>
          </div>
